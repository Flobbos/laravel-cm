...
class CampaignController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()
                ->route('laravel-cm::campaigns.index')
                ->withMessage(trans('laravel-cm::campaigns.create_success', ['campaign_id' => $campaign_id]));
        } catch (Exception $ex) {
    ...
    public function edit($campaign_id, ListContract $lists, TemplateContract $templates)
    {
        try {
            ...
            return view('laravel-cm::campaigns.edit')
                ->withCampaign($campaign)
                ->withLists($lists->get())
                ->withTemplates($templates->get());
        } catch (Exception $ex) {
            return redirect()->back()->withErrors($ex->getMessage());
        }
    }
    ...
    public function update($campaign_id, Request $request)
    {
        ...
        try {
            ...
            return redirect()
                ->route('laravel-cm::campaigns.index')
                ->withMessage(trans('laravel-cm::campaigns.update_success', ['new_campaign_id' => $new_campaign_id]));
        } catch (Exception $ex) {
            return redirect()->back()->withErrors($ex->getMessage());
        }
    }
    ...
    public function saveScheduleCampaign(Request $request, $campaign_id)
    {
        ...
        try {
            ...
            return redirect()
                ->route('laravel-cm::campaigns.index')
                ->withMessage(trans('laravel-cm::campaigns.schedule_success'));
        } catch (Exception $ex) {
    ...
    public function unScheduleCampaign($campaign_id)
    {
        try {
            ...
            return redirect()
                ->route('laravel-cm::campaigns.index')
                ->withMessage(trans('laravel-cm::campaigns.unschedule_success'));
        } catch (Exception $ex) {
