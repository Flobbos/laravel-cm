...
**Note:** The remote compiler now uses Bearer Token authentication instead of basic authentication. Make sure your API token is kept secure and never committed to version control.
