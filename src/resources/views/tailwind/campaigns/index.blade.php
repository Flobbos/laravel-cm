<x-app-layout>
    ...
    <div class="container xl mx-auto mt-10 pb-10">
        <div class="flex flex-col relative bg-white rounded border border-gray-300">
            <div class="grid lg:grid-cols-2 sm:grid-cols-1 p-5">
                ...
                <div class="text-right">
                    <a href="{{ route('laravel-cm::campaigns.create') }}" class="inline-block font-normal text-center px-2 py-1 text-md leading-normal text-base rounded cursor-pointer text-white bg-blue-500 hover:text-white hover:bg-blue-400 hover:text-blue-100">
                                ...
                                <div class="flex justify-end" role="group">
                                    ...
                                    <div x-data="{ show: false }"  @click.away="show = false">
                                        ...
                                        <div x-show="show" class="text-left absolute bg-gray-100 z-10 shadow-md" style="min-width:10rem">
                                            <a class="flex p-2 text-sm hover:underline hover:bg-white" href="{{route('laravel-cm::campaigns.show-preview',$campaign->CampaignID)}}">@lang('laravel-cm::campaigns.send_preview')</a>
                                            <a class="flex p-2 text-sm hover:underline hover:bg-white" href="{{route('laravel-cm::campaigns.show-send',$campaign->CampaignID)}}">@lang('laravel-cm::campaigns.schedule')</a>
                                        </div>
                                    </div>
                                    ...
                                    <form action="{{ route('laravel-cm::campaigns.destroy',$campaign->CampaignID) }}"
                                        method="POST">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
                                        <button class="bg-red-500 text-white hover:bg-red-400 hover:text-red-100 px-2 py-1 text-sm mx-0 outline-none rounded-r"
        ...
        <div class="flex flex-col relative bg-white rounded border border-gray-300 mt-10">
            <div class="p-5">
                        ...
                        <tr class="border-b">
                            ...
                            <td class="text-right p-2">
                                <div class="flex justify-end" role="group">
                                    ...
                                    <a class="bg-yellow-500 text-white hover:bg-yellow-400 rounded-r px-2 py-1 text-sm mx-0 outline-none" href="{{route('laravel-cm::campaigns.unschedule',$campaign->CampaignID)}}">@lang('laravel-cm::campaigns.unschedule')</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
