                ...
                <form action="{{ route('laravel-cm::lists.update',$list->ListID) }}" role="form" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="flex-auto p-5">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="block w-full py-2 px-3 text-base font-normal leading-normal text-gray-700 bg-white border border-gray-400 rounded" type="text" name="Title" value="{{old('Title', $list->Title)}}" />
                        </div>

                        <div class="mb-4">
                            <label class="inline-block mb-2" for="UnsubscribePage">@lang('laravel-cm::lists.unsubscribe_page')</label>
                            <input class="block w-full py-2 px-3 text-base font-normal leading-normal text-gray-700 bg-white border border-gray-400 rounded" type="text" name="UnsubscribePage" value="{{old('UnsubscribePage',$list->UnsubscribePage)}}" />
                        </div>

                        <div class="mb-4">
                            <label class="inline-block mb-2" for="ConfirmationSuccessPage">@lang('laravel-cm::lists.success_page')</label>
                            <input class="block w-full py-2 px-3 text-base font-normal leading-normal text-gray-700 bg-white border border-gray-400 rounded" type="text" name="ConfirmationSuccessPage" value="{{old('ConfirmationSuccessPage',$list->ConfirmationSuccessPage)}}" />
                        </div>
