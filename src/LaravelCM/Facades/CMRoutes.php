...
class CMRoutes extends Facade {
    ...
    public static function load(){
        ...
        Route::get('templates/{id}/send-preview','NewsletterTemplateController@sendPreview')->name('templates.send-preview');
        // Newslettertemplate Routes
        Route::resource('laravel-cm/templates', 'NewsletterTemplateController');
    }
}